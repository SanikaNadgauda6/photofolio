...
const SignIn = () => {
  ...
  return () => unsubscribe();
    ...
    const handleSignUp = async() => {
            ...
            await updateProfile(loggedInUser, { displayName: username, photoURL: photoURL }); 
        ...
        <div className={`container ${isActive ? 'active' : ''}`} id="container">
            <div className="form-container sign-up">
                    ...
                    <div className="social-icons">
                        <FontAwesomeIcon className = "google" icon={faGoogle} onClick={handleGoogleSignIn} />
                    </div>
                    <span>or use your email for register</span>
                    <input type="text" placeholder="Full Name" onChange={(e) =>setUsername(e.target.value)}/>
                    <input type="email" placeholder="Email" onChange={(e) =>setEmail(e.target.value)} />
                <input type="password" placeholder="Password" onChange={(e) => setPassword(e.target.value)} />
                      <input type="text" placeholder="Profile Picture URL" onChange={(e) => setPhotoURL(e.target.value)} />
